Contributing to Dach Core
============================

The Dach Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Dach Core project, and is not to be
confused with overall Dach Network Protocol consensus changes.

Whether a pull request is merged into Dach Core rests with the project merge
...
Patches that change Dach consensus rules are considerably more involved than
...
Where a patch set proposes to change the Dach consensus, it must have been
...
The project leader is the release manager for each Dach Core release.
