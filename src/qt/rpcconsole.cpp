                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzDACHXPathCustom = GetArg("-zdachxbackuppath", "");
    ...
    if(!strzDACHXPathCustom.empty()) {
        ui->wallet_customzdachxbackuppath->setText(QString::fromStdString(strzDACHXPathCustom));
        ui->wallet_customzdachxbackuppath_label->setVisible(true);
        ui->wallet_customzdachxbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzDACHXPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Dach RPC console.") + "<br>" +
