 ...
 */
    ...
    typeWidget->addItem(tr("Minted"), TransactionFilterProxy::TYPE(TransactionRecord::StakeMint) | TransactionFilterProxy::TYPE(TransactionRecord::StakeZDACHX));
    typeWidget->addItem(tr("Masternode Reward"), TransactionFilterProxy::TYPE(TransactionRecord::MNReward));
    // dachx typeWidget->addItem(tr("Received DACHX from zDACHX"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    // dachx typeWidget->addItem(tr("Zerocoin Mint"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinMint));
    // dachx typeWidget->addItem(tr("Zerocoin Spend"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend));
    // dachx typeWidget->addItem(tr("Zerocoin Spend, Change in zDACHX"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zDachx));
    // dachx typeWidget->addItem(tr("Zerocoin Spend to Self"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_FromMe));
