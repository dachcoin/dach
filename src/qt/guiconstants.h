...
/* Dach GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Dach"
#define QAPP_ORG_DOMAIN "dach.org"
#define QAPP_APP_NAME_DEFAULT "Dach-Qt"
#define QAPP_APP_NAME_TESTNET "Dach-Qt-testnet"
