                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DachX Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Dach address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dach: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zDACHX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Dach Core"), this);
    aboutAction->setStatusTip(tr("Show information about Dach Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Dach"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Dach addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Dach addresses"));
    ...
    openAction->setStatusTip(tr("Open a Dach: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Dach Core help message to get a list with possible Dach command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Dach Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Dach network", "", count));
}
...
{
    QString strTitle = tr("Dach Core"); // default title
