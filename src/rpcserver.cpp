...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Dach features */
        {"dach", "masternode", &masternode, true, true, false},
        {"dach", "listmasternodes", &listmasternodes, true, true, false},
        {"dach", "getmasternodecount", &getmasternodecount, true, true, false},
        {"dach", "masternodeconnect", &masternodeconnect, true, true, false},
        {"dach", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"dach", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"dach", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"dach", "masternodecurrent", &masternodecurrent, true, true, false},
        {"dach", "masternodedebug", &masternodedebug, true, true, false},
        {"dach", "startmasternode", &startmasternode, true, true, false},
        {"dach", "createmasternodekey", &createmasternodekey, true, true, false},
        {"dach", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"dach", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"dach", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"dach", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"dach", "getmasternodescores", &getmasternodescores, true, true, false},
        {"dach", "mnbudget", &mnbudget, true, true, false},
        {"dach", "preparebudget", &preparebudget, true, true, false},
        {"dach", "submitbudget", &submitbudget, true, true, false},
        {"dach", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"dach", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"dach", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"dach", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"dach", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"dach", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"dach", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"dach", "checkbudgets", &checkbudgets, true, true, false},
        {"dach", "mnsync", &mnsync, true, true, false},
        {"dach", "spork", &spork, true, true, false},
        {"dach", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        // dachx {"zerocoin", "getzerocoinbalance", &getzerocoinbalance, false, false, true},
        ...
        {"zerocoin", "getzdachxseed", &getzdachxseed, false, false, true},
        {"zerocoin", "setzdachxseed", &setzdachxseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzdachx", &searchdzdachx, false, false, true},
        {"zerocoin", "dzdachxstate", &dzdachxstate, false, false, true}
...
{
    return "> dach-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:32654/\n";
}
