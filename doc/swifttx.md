...
This mechanism has been integrated into Bitcore-Node-Dach which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Dach-Project/insight-api-dach#web-socket-api](https://github.com/Dach-Project/insight-api-dach#web-socket-api) 
* API: [https://github.com/Dach-Project/insight-api-dach#swifttx-transactions](https://github.com/Dach-Project/insight-api-dach#swifttx-transactions) 
...
By default, the Dach Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Dach Core daemon:
