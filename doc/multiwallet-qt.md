...
In order to support loading of multiple wallets in dach-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dach.cpp.
...
Changes to dach.cpp
----------------------
dach.cpp is the entry point into dach-qt, and as such, will require some minor modifications to provide hooks for
