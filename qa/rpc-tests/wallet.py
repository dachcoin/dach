...
#   c) node1 mines 32 blocks, so now node 0 has 60001dachx, node 1 has 4250dachx, node2 has none.
#   d) node0 sends 601 dachx to node2, in two transactions (301 dachx, then 300 dachx).
